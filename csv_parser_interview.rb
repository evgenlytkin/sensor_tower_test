...
# NOTE: Please put your parser and any tests/benchmarks in a single file that
# can be run from the command line. You may use Ruby, Python, or Go as long as
# you include the provided test cases.
